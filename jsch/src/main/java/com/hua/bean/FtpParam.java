...
public final class FtpParam {
	...
	private static final String CONFIG_PATH = "/conf/properties/jsch.properties";
	...
	static
	{
		...
		instance.setHost(props.getProperty("ftp.host"));
		...
		instance.setTimeout(Integer.parseInt(props.getProperty("ftp.timeout")));
