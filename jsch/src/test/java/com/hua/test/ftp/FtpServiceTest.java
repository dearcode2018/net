...
import com.hua.service.impl.FtpServiceImpl;
 ...
 * FtpServiceTest
 */
public final class FtpServiceTest extends BaseTest {
	...
	public void beforeMethod() {
		try {
			ftpService = new FtpServiceImpl(FtpParam.getInstance());
		} catch (Exception e) {
	...
	public void testIsDirectory() {
		try {
			...
			boolean flag = ftpService.isDirectory(remote);
